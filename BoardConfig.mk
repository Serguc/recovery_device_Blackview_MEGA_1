...
# Параметры из заводских конфигов Himax HX83102
...
TW_ROTATION := 0
#TW_RECOVERY_TOUCHSCREEN_FLIP_X := true
#TW_RECOVERY_TOUCHSCREEN_FLIP_Y := true
TW_FRAMERATE := 60
...
# Если тач будет работать правильно, но зеркально по горизонтали:
# TW_INPUT_INVERT_X := true

# Если зеркально по вертикали:
# TW_INPUT_INVERT_Y := true
